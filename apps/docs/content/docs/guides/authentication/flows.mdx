...
- [Session Management](/docs/guides/authentication/sessions) - How sessions work
- [Middleware](/docs/guides/authentication/middleware) - Protecting routes
- [Multi-Tenancy](/docs/guides/multi-tenancy) - Tenant onboarding after auth
