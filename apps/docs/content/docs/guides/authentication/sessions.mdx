...
<Tabs items={['React SDK', 'Next.js (via context)']}>
<Tab value="React SDK">
...
- [Authentication Flows](/docs/guides/authentication/flows) - Implement login, registration, and recovery
- [Middleware](/docs/guides/authentication/middleware) - Protect routes with middleware
- [Multi-Tenancy](/docs/guides/multi-tenancy) - How sessions work with tenants
