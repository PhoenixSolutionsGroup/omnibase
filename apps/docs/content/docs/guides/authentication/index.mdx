...
import { KeyRound, Users, Shield, Settings } from 'lucide-react';
...
<Cards>
  <Card title="Session Management" icon={<KeyRound />} href="/docs/guides/authentication/sessions">
    Server-side session handling with automatic cookie management
  </Card>
  <Card title="Authentication Flows" icon={<Users />} href="/docs/guides/authentication/flows">
    Pre-built forms for login, registration, recovery, and verification
  </Card>
  <Card title="Route Protection" icon={<Shield />} href="/docs/guides/authentication/middleware">
    Middleware for protecting routes and managing tenant context
  </Card>
  <Card title="Account Settings" icon={<Settings />} href="/docs/guides/authentication/flows#settings-flow">
...
<Callout type="info">
See the [Middleware Guide](/docs/guides/authentication/middleware) for detailed configuration options and patterns.
</Callout>
...
<Files>
  <Folder name="app" defaultOpen>
    <Folder name="auth">
      <File name="[...flow]/page.tsx" />
    </Folder>
    <Folder name="api">
      <Folder name="auth">
        <File name="logout/route.ts" />
      </Folder>
    </Folder>
...
<Cards>
  ...
  <Card title="Authentication Flows" href="/docs/guides/authentication/flows">
    Implement login, registration, and recovery flows
  </Card>
  <Card title="Middleware" href="/docs/guides/authentication/middleware">
