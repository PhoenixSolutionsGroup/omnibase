...
- [Coupons & Promotions](/docs/guides/stripe/coupons-promotions) — Discount codes
- [Webhooks](/docs/guides/stripe/webhooks) — Event handling
- [UI Components](/docs/guides/stripe/ui-components) — PricingTable component
