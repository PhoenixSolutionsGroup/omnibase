...
- [Role Configuration](/docs/guides/rbac/roles) — Create roles from permission templates
- [Permissions Concept](/docs/concepts/permissions) — Deep dive into how permissions work
