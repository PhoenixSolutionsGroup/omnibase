...
The invitation email template can be customized. See the [Email Templates](/docs/guides/email-templates) guide for details.
...
- [RBAC](/docs/guides/multi-tenancy/rbac) — Configure roles and permissions
- [Role Configuration](/docs/guides/multi-tenancy/rbac/roles) — Configure who can invite
- [Data Isolation](/docs/guides/multi-tenancy/isolation) — How member data is scoped
