...
<Accordion title="SwitchActiveTenant Component">
...
<Tabs items={['Server Action', 'Client Component']}>
...
- [Team Invitations](/docs/guides/multi-tenancy/invitations) — Invite users to your tenant
- [RBAC](/docs/guides/multi-tenancy/rbac) — Configure roles and permissions
- [Data Isolation](/docs/guides/multi-tenancy/isolation) — How RLS protects tenant data
