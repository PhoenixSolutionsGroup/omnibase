...
func (s *Service) createProduct(ctx context.Context, productConfig models.Product, configID uuid.UUID) (*models.ProductChange, error) {
...
func (s *Service) updateProduct(ctx context.Context, update models.ProductUpdate) (*models.ProductChange, error) {
	if update.ID == "free" {
		return &models.ProductChange{
			ProductID:   update.ID,
...
func (s *Service) archiveProduct(ctx context.Context, productID string) (*models.ProductChange, error) {
	if productID == "free" {
		return &models.ProductChange{
			ProductID:   productID,
...
func (s *Service) unarchiveExistingProduct(ctx context.Context, productConfig models.Product, configID uuid.UUID) (*models.ProductChange, error) {
	if productConfig.ID == "free" {
		return &models.ProductChange{
			ProductID:   productConfig.ID,
			ProductName: productConfig.Name,
