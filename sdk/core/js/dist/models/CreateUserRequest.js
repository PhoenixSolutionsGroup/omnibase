...
const CreateUserRequestName_1 = require("./CreateUserRequestName");
/**
...
function CreateUserRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'name': (0, CreateUserRequestName_1.CreateUserRequestNameFromJSON)(json['name']),
    };
}
...
function CreateUserRequestToJSONTyped(value, ignoreDiscriminator = false) {
    ...
    return {
        ...
        'name': (0, CreateUserRequestName_1.CreateUserRequestNameToJSON)(value['name']),
    };
}
