...
exports.instanceOfBadRequest = instanceOfBadRequest;
...
exports.BadRequestToJSONTyped = BadRequestToJSONTyped;
/**
 * Check if a given object implements the BadRequest interface.
 */
function instanceOfBadRequest(value) {
...
function BadRequestToJSON(json) {
    return BadRequestToJSONTyped(json, false);
}
function BadRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
