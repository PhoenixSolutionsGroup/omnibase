...
const DeleteRelationshipResponse_1 = require("./DeleteRelationshipResponse");
/**
...
function DeleteRelationship200ResponseFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'status': json['status'],
        'data': json['data'] == null ? undefined : (0, DeleteRelationshipResponse_1.DeleteRelationshipResponseFromJSON)(json['data']),
    };
}
...
function DeleteRelationship200ResponseToJSONTyped(value, ignoreDiscriminator = false) {
    ...
    return {
        'status': value['status'],
        'data': (0, DeleteRelationshipResponse_1.DeleteRelationshipResponseToJSON)(value['data']),
    };
}
