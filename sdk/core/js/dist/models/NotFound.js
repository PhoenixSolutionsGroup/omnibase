...
exports.instanceOfNotFound = instanceOfNotFound;
...
exports.NotFoundToJSONTyped = NotFoundToJSONTyped;
/**
...
function NotFoundToJSON(json) {
    return NotFoundToJSONTyped(json, false);
}
function NotFoundToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
