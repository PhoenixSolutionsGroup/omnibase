...
exports.instanceOfUnauthorized = instanceOfUnauthorized;
...
exports.UnauthorizedToJSONTyped = UnauthorizedToJSONTyped;
/**
 * Check if a given object implements the Unauthorized interface.
 */
function instanceOfUnauthorized(value) {
...
function UnauthorizedToJSON(json) {
    return UnauthorizedToJSONTyped(json, false);
}
function UnauthorizedToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
