 ...
 */
export function instanceOfProductUI(value) {
    return true;
}
export function ProductUIFromJSON(json) {
    return ProductUIFromJSONTyped(json, false);
}
export function ProductUIFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function ProductUIToJSON(json) {
    return ProductUIToJSONTyped(json, false);
}
export function ProductUIToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
