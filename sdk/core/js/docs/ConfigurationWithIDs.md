...
```typescript
import type { ConfigurationWithIDs } from '@omnibase/core-js'
...
const example = {
  ...
  "promotionCodes": null,
  "version": null,
} satisfies ConfigurationWithIDs
...
const exampleParsed = JSON.parse(exampleJSON) as ConfigurationWithIDs
