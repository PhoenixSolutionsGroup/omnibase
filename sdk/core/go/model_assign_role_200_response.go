...
type AssignRole200Response struct {
	Data *TenantsAssignRoleResponse `json:"data,omitempty"`
	// HTTP status code
...
func (o *AssignRole200Response) GetData() TenantsAssignRoleResponse {
	if o == nil || IsNil(o.Data) {
		var ret TenantsAssignRoleResponse
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given TenantsAssignRoleResponse and assigns it to the Data field.
