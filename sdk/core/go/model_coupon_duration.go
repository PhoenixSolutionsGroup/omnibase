...
// CouponDuration Duration for the coupon discount. - once: Discount applies to the first charge only - repeating: Discount applies for a specified number of months (requires duration_in_months) - forever: Discount applies indefinitely (only valid with percent_off, not amount_off) 
