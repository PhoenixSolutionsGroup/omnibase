...
func (o *SessionDevice) GetAdditionalPropertiesField() map[string]interface{} {
...
func (o *SessionDevice) GetAdditionalPropertiesFieldOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.AdditionalPropertiesField) {
...
func (o *SessionDevice) HasAdditionalPropertiesField() bool {
	if o != nil && !IsNil(o.AdditionalPropertiesField) {
		return true
	}
...
func (o *SessionDevice) SetAdditionalPropertiesField(v map[string]interface{}) {
