...
type AcceptInvite200Response struct {
	...
	Data *AcceptInviteResponse `json:"data,omitempty"`
}
...
// SetData gets a reference to the given AcceptInviteResponse and assigns it to the Data field.
