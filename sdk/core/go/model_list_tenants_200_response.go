...
type ListTenants200Response struct {
	...
	Data *ListTenantsResponse `json:"data,omitempty"`
}
...
// SetData gets a reference to the given ListTenantsResponse and assigns it to the Data field.
...
func (o *ListTenants200Response) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varListTenants200Response)
