...
// APIClient manages communication with the Omnibase REST API API v0.9.17
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.V1EventsAPI = (*V1EventsAPIService)(&c.common)
