...
// IdentityCredentials struct for IdentityCredentials
...
func (o *IdentityCredentials) GetAdditionalPropertiesField() map[string]interface{} {
...
func (o *IdentityCredentials) GetAdditionalPropertiesFieldOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.AdditionalPropertiesField) {
...
func (o *IdentityCredentials) HasAdditionalPropertiesField() bool {
	if o != nil && !IsNil(o.AdditionalPropertiesField) {
		return true
	}
...
func (o *IdentityCredentials) SetAdditionalPropertiesField(v map[string]interface{}) {
