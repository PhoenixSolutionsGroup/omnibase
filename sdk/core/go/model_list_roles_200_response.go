...
type ListRoles200Response struct {
	...
	Data *RolesListResponse `json:"data,omitempty"`
}
...
// SetData gets a reference to the given RolesListResponse and assigns it to the Data field.
