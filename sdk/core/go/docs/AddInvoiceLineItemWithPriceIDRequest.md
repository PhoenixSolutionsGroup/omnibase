...
------------ | ------------- | ------------- | -------------
**PriceId** | Pointer to **string** | Config price ID (e.g., \&quot;hetzner_cx23_nbg1_hourly\&quot;) - looked up via GetStripeIDByConfigID. Provide either this or stripe_price_id. | [optional] 
**StripePriceId** | Pointer to **string** | Raw Stripe price ID (e.g., \&quot;price_1ABC...\&quot;) - used directly. Provide either this or price_id. | [optional] 
**Quantity** | **int64** | Quantity of units (required) | 
