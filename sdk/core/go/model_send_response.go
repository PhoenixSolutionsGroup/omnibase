...
func NewSendResponse(message string) *SendResponse {
	this := SendResponse{}
...
func (o *SendResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varSendResponse := _SendResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSendResponse)

	if err != nil {
		return err
	}

	*o = SendResponse(varSendResponse)
