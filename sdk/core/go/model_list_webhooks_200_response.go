...
type ListWebhooks200Response struct {
	...
	Data *ListWebhooksResponse `json:"data,omitempty"`
}
...
// SetData gets a reference to the given ListWebhooksResponse and assigns it to the Data field.
